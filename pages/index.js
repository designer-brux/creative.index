  ...
  return (
    <>
      <Head>
        ...
        {/* Fontes e Scripts aqui */}
        <link href="https://api.fontshare.com/v2/css?f[]=general-sans@200,300,400,500,600,700&display=swap" rel="stylesheet" />
        <script src="https://kit.fontawesome.com/4862f6187b.js" crossOrigin="anonymous" async></script>
      </Head>
      ...
      <section className="container">
        ...
        <section className="hero">
          <div className="hero-text">
            <h2 className="heading-secondary reveal-text">
              Dive into the creative legacy of the world’s luxury maisons, tracing the visionaries who shaped style, culture, and identity.
            </h2>
          </div>
        ...
        <section className="categories-section">
          <h2 className="heading-tertiary reveal-text">SEARCH BY <br />CATEGORIES</h2>
            ...
            <ul className="updates-list">
              {designersData.map((item) => (
                <li key={item.id} className="update-item reveal-text">
                  <Link href={`/creatives/${item.slug}`} className="update-link-wrapper">
      ...
      <footer className="footer">
        <div className="footer-logo">
          ...
          <p className="small-p">
            All brand names and logos on creative.index are property of their owners. 
            This is an independent editorial project, not affiliated with any brand.
          </p> 
        </div>
